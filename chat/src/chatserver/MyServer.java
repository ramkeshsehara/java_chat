...
{
try{
	ss=new ServerSocket(PORT,50,InetAddress.getByName("10.2.6.73"));
...
/**
 * @param <JLavel>*******************************/
class MyClient<JLavel> implements ActionListener
{
Socket s;
DataInputStream dis;
DataOutputStream dos;

JButton sendButton, logoutButton,loginButton,exitButton,registerButton,submitButton;
JFrame chatWindow;
...
if (temp==registerButton)
{  

	
	JFrame frame = new JFrame("Register For Facebook");
	...
	JLabel emailLavel = new JLabel("Email id");
	emailLavel.setBounds(10, 80, 80, 25);
	frame.add(emailLavel);
	...
	phoneText.setBounds(100,70,160,25);
	frame.add(phoneText);
	...
	submitButton.setBounds(150, 150, 80, 40);
...
if(temp==submitButton)
{		 
 System.out.println("finaly u got it ");
...
{
if(s==null)
 	{JOptionPane.showMessageDialog(chatWindow,"if you have register then login either 1st register then login"); return;}
try{
...
private class SubmitButtonHandler implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	JButton sub=(JButton)e.getSource();
    	if(sub==submitButton)
    	{
    		...
    		System.out.println("Please Fill all Text filed this is necessary for every user ");
...
{
try{
     s=new Socket(InetAddress.getByName("10.2.6.73"),MyServer.PORT);
